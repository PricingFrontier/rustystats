...
class GLMResults:
    ...
    @property
    def response(self) -> npt.NDArray[np.float64]: ...
    @property
    def response_scale(self) -> float | None: ...
    @property
    ...
    @property
    def stationary(self) -> bool | None: ...
    @property
    def max_std_score(self) -> float | None: ...
    @property
...
def fit_multinomial_py(
    ...
    nonpos_indices: list[int] | None = None,
    solver: str = "dense",
    matrix_free_cg_max_iter: int = 80,
    matrix_free_cg_tol: float = 1e-4,
    matrix_free_cg_damping: float = 1e-6,
) -> MultinomialResults: ...
