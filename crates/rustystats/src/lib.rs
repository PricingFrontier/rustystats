// PyO3 macro-generated code triggers these lints; suppress at crate level.
...
fn _rustystats(m: &Bound<'_, PyModule>) -> PyResult<()> {
    ...
    m.add_function(wrap_pyfunction!(
        design_matrix_py::encode_categorical_py,
        m
    )?)?;
    m.add_function(wrap_pyfunction!(design_matrix_py::factorize_strings_py, m)?)?;
    m.add_function(wrap_pyfunction!(
        design_matrix_py::encode_categorical_indices_py,
        m
    )?)?;
    m.add_function(wrap_pyfunction!(
        design_matrix_py::build_cat_cat_interaction_py,
        m
    )?)?;
    m.add_function(wrap_pyfunction!(
    ...
    m.add_function(wrap_pyfunction!(
        design_matrix_py::build_cont_cont_interaction_py,
        m
    )?)?;
    m.add_function(wrap_pyfunction!(
    ...
    m.add_function(wrap_pyfunction!(
        target_encoding_py::apply_target_encoding_py,
        m
    )?)?;
    m.add_function(wrap_pyfunction!(
        target_encoding_py::target_encode_with_exposure_py,
        m
    )?)?;
    m.add_function(wrap_pyfunction!(
        target_encoding_py::apply_exposure_weighted_target_encoding_py,
        m
    )?)?;
    m.add_function(wrap_pyfunction!(
        target_encoding_py::frequency_encode_py,
        m
    )?)?;
    m.add_function(wrap_pyfunction!(
        target_encoding_py::apply_frequency_encoding_py,
        m
    )?)?;
    m.add_function(wrap_pyfunction!(
        target_encoding_py::target_encode_interaction_py,
        m
    )?)?;
    m.add_function(wrap_pyfunction!(
        target_encoding_py::target_encode_interaction_with_exposure_py,
        m
    )?)?;

    // Diagnostics
    m.add_function(wrap_pyfunction!(
        diagnostics_py::compute_calibration_curve_py,
        m
    )?)?;
    m.add_function(wrap_pyfunction!(
        diagnostics_py::compute_discrimination_stats_py,
        m
    )?)?;
    m.add_function(wrap_pyfunction!(
        diagnostics_py::compute_ae_continuous_py,
        m
    )?)?;
    m.add_function(wrap_pyfunction!(
    ...
    m.add_function(wrap_pyfunction!(
        diagnostics_py::compute_loss_metrics_py,
        m
    )?)?;
    ...
    m.add_function(wrap_pyfunction!(
        diagnostics_py::hosmer_lemeshow_test_py,
        m
    )?)?;
    m.add_function(wrap_pyfunction!(
        diagnostics_py::compute_fit_statistics_py,
        m
    )?)?;
    m.add_function(wrap_pyfunction!(
        diagnostics_py::compute_dataset_metrics_py,
        m
    )?)?;
    m.add_function(wrap_pyfunction!(
        diagnostics_py::compute_residual_summary_py,
        m
    )?)?;
    m.add_function(wrap_pyfunction!(
        diagnostics_py::compute_residual_pattern_py,
        m
    )?)?;
    m.add_function(wrap_pyfunction!(
    ...
    m.add_function(wrap_pyfunction!(
        diagnostics_py::compute_deviance_residuals_py,
        m
    )?)?;
    m.add_function(wrap_pyfunction!(
        diagnostics_py::compute_null_deviance_py,
        m
    )?)?;
    m.add_function(wrap_pyfunction!(
    ...
    // ONNX export
    m.add_function(wrap_pyfunction!(
        export_onnx_py::build_onnx_glm_scoring_py,
        m
    )?)?;
    m.add_function(wrap_pyfunction!(
        export_onnx_py::serialize_onnx_graph_py,
        m
    )?)?;
