...
gaussian_results = validate_family("GAUSSIAN", y_gaussian, X, sm.families.Gaussian(), "gaussian")
...
poisson_results = validate_family(
    "POISSON", y_poisson.astype(float), X, sm.families.Poisson(), "poisson"
)
...
gamma_results = validate_family(
    "GAMMA", y_gamma, X, sm.families.Gamma(sm.families.links.Log()), "gamma"
)
...
binomial_results = validate_family("BINOMIAL", y_binom, X, sm.families.Binomial(), "binomial")
