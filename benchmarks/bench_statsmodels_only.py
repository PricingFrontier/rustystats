...
from statsmodels.genmod.families import Binomial, Gamma, Gaussian, NegativeBinomial, Poisson
...
def main():
    ...
    print("Total columns after encoding: 101")
    print("=" * 50)
    ...
    for family in families:
        ...
        for n_rows in SIZES:
            ...
            def fit_fn(response=y, design=X, family_obj=sm_family):
                return sm.GLM(response, design, family=family_obj).fit()
